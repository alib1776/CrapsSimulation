...
public class TestingCraps
{
	...
	public TestingCraps()
	{
		...
		game = new GameCraps(new Die(), new Die()); // two "fair" Die objects
	...
	{
		TestingCraps test = new TestingCraps();

		StdOut.println("Starting simulation of " + NUM_TO_PLAY + " games...");

		GameCraps.showOutputcHANGE = false; // turn off output to speed up
		// simulation
