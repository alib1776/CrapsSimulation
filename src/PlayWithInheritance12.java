...
public class PlayWithInheritance12
{
	...
	public static void main(String[] args)
	{
		...
		CrookedDie22222 crooked2 = new CrookedDie22222();
		...
		else if (RUN_EXAMPLE == 6)
		{
			...
			DiceChanelll dice = new DiceChanelll(die1, crooked1); // we'll try substituting here
